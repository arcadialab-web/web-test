      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="p-10 bg-surface-container-low rounded-xl space-y-6 transition-all hover:-translate-y-2 duration-500 border border-outline-variant/30 text-center flex flex-col items-center">
            <span className="material-symbols-outlined text-6xl text-primary font-light">auto_awesome</span>
          ...
          <div className="p-10 bg-surface-container-low rounded-xl space-y-6 transition-all hover:-translate-y-2 duration-500 border border-outline-variant/30 text-center flex flex-col items-center">
            <span className="material-symbols-outlined text-6xl text-primary font-light">self_improvement</span>
          ...
          <div className="p-10 bg-surface-container-low rounded-xl space-y-6 transition-all hover:-translate-y-2 duration-500 border border-outline-variant/30 text-center flex flex-col items-center">
            <span className="material-symbols-outlined text-6xl text-primary font-light">favorite</span>
